...
if __name__ == "__main__":
    print(os.getcwd())
    std_excel_file_path = os.path.dirname(__file__) + "/../../dataset/answerfile_template.xlsx"  # 원본 엑셀 파일 경로
    renew_excel_file_path = os.path.dirname(__file__) + "/../../dataset/renew.xlsx"  # 크롤링 후 갱신하는 파일 경로
    new_file_path = os.path.dirname(__file__) + "/../../dataset/answerfile.xlsx"  # 새롭게 저장할 엑셀 파일 경로
